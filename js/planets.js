...
async function showAllPerson(data) {
    ...
    for (const element of data) {
        ...
        let imgSrc = `https://starwars-visualguide.com/assets/img/planets/${filmId}.jpg`;
...
function showDetails(data, url){
    ...
    const {name,population,rotation_period,orbital_period,diameter,climate} = data
    title.textContent = name
    li[0].textContent = population
    li[1].textContent = rotation_period
    li[2].textContent = orbital_period
    li[3].textContent = diameter
